...
const COMPUTE_INTERVAL_MS = parseInt(process.env.COMPUTE_INTERVAL_MS || '1000', 10);
...
app.get("/", (req, res) => {
  ...
  // Same set the live AUTO bot can trade on Kalshi (NEAR/DOGE opt-in).
  ...
  function parseBacktestSettings(source = {}) {
    ...
    const pick = (k) => source[k] ?? live[k];
    return {
      // ── shared ───────────────────────────────────────────────────────────
      strategyMode: pick('strategyMode'),
      edgeThresholdPct: pick('edgeThresholdPct'),
      minConfidence: pick('minConfidence'),
      stopLossCents: pick('stopLossCents'),
      takeProfitCents: pick('takeProfitCents'),
      minEntryCents: pick('minEntryCents'),
      stopRecoveryCents: pick('stopRecoveryCents'),
      stopRecoveryMaxMinutes: pick('stopRecoveryMaxMinutes'),
      peerCascadeMaxMinutes: pick('peerCascadeMaxMinutes'),
      postStopMaxOneMinutes: pick('postStopMaxOneMinutes'),
      postStopSameSideCooldownMinutes: pick('postStopSameSideCooldownMinutes'),
      stakeDollars: pick('stakeDollars'),
      stakingStrategy: pick('stakingStrategy'),
      maxOpenPositions: pick('maxOpenPositions'),
      skimMode: pick('skimMode'),
      skimPercent: pick('skimPercent'),
      skimFixedDollars: pick('skimFixedDollars'),
      insuranceCapDollars: pick('insuranceCapDollars'),
      insuranceFloorDollars: pick('insuranceFloorDollars'),
      insuranceOverflowDollars: pick('insuranceOverflowDollars'),
      paperStartingBalanceDollars: pick('paperStartingBalanceDollars'),
      assumedEntryCents: source.assumedEntryCents ?? 50,
      // ── settle ───────────────────────────────────────────────────────────
      settleEntryMinCents: pick('settleEntryMinCents'),
      settleEntryMaxCents: pick('settleEntryMaxCents'),
      settleStopLossCents: pick('settleStopLossCents'),
      ...
      modelMaxEntryCents:          pick('modelMaxEntryCents'),
      modelMinEntryLeanPct:        pick('modelMinEntryLeanPct'),
      modelMinEntryLeanPctGold:    pick('modelMinEntryLeanPctGold'),
      modelMinEntryLeanPctSilver:  pick('modelMinEntryLeanPctSilver'),
      modelMinEntryLeanPctOil:     pick('modelMinEntryLeanPctOil'),
      modelMinEntryLeanPctBTC:     pick('modelMinEntryLeanPctBTC'),
      modelMinEntryLeanPctETH:     pick('modelMinEntryLeanPctETH'),
      modelMinEntryLeanPctSOL:     pick('modelMinEntryLeanPctSOL'),
      modelMinEntryLeanPctBnb:     pick('modelMinEntryLeanPctBnb'),
      modelEntryLiveLeanMarginPct: pick('modelEntryLiveLeanMarginPct'),
      modelMaxAdverseCents:        pick('modelMaxAdverseCents'),
      modelMaxLossCents:           pick('modelMaxLossCents'),
      modelHardAdverseCents:       pick('modelHardAdverseCents'),
      modelHardStopFloorCents:     pick('modelHardStopFloorCents'),
      modelRichStopFloorCents:     pick('modelRichStopFloorCents'),
      modelRichStopEntryMinCents:  pick('modelRichStopEntryMinCents'),
      modelLeanFloorBaseDrop:      pick('modelLeanFloorBaseDrop'),
      modelLeanFloorScale:         pick('modelLeanFloorScale'),
      modelLeanFloorBaseEntry:     pick('modelLeanFloorBaseEntry'),
      modelMinRoomToFloorCents:    pick('modelMinRoomToFloorCents'),
      modelBankGreenCents:         pick('modelBankGreenCents'),
      modelMinTpCents:             pick('modelMinTpCents'),
      modelNearTargetBankCents:    pick('modelNearTargetBankCents'),
      modelTrailCents:             pick('modelTrailCents'),
      commodityTpCentsGold:        pick('commodityTpCentsGold'),
      commodityTpCentsSilver:      pick('commodityTpCentsSilver'),
      commodityTpCentsOil:         pick('commodityTpCentsOil'),
      commodityStopCentsGold:      pick('commodityStopCentsGold'),
      commodityStopCentsSilver:    pick('commodityStopCentsSilver'),
      commodityStopCentsOil:       pick('commodityStopCentsOil'),
      commodityTrailCentsGold:     pick('commodityTrailCentsGold'),
      commodityTrailCentsSilver:   pick('commodityTrailCentsSilver'),
      commodityTrailCentsOil:      pick('commodityTrailCentsOil'),
      modelLiveLeanMarginPct:      pick('modelLiveLeanMarginPct'),
      modelSoftLeanMarginPct:      pick('modelSoftLeanMarginPct'),
      modelLeanDecayDropPts:       pick('modelLeanDecayDropPts'),
      modelSettleCloseMinutes:     pick('modelSettleCloseMinutes'),
      modelLateBarrierMinutes:     pick('modelLateBarrierMinutes'),
      modelPreCloseForceMinutes:   pick('modelPreCloseForceMinutes'),
      modelLateExtendMinConfidence: pick('modelLateExtendMinConfidence'),
      commoditySettleCloseMinutes: pick('commoditySettleCloseMinutes'),
      commodityLateBarrierMinutes: pick('commodityLateBarrierMinutes'),
      modelMinMinutesToOpen:       pick('modelMinMinutesToOpen'),
      modelOpenGraceMs:            pick('modelOpenGraceMs'),
      modelMinHoldSeconds:         pick('modelMinHoldSeconds'),
      modelStagnationSeconds:      pick('modelStagnationSeconds'),
      modelStagnationMinProgressCents: pick('modelStagnationMinProgressCents'),
      modelRapidAdverseCents:      pick('modelRapidAdverseCents'),
      modelBeChaseSeconds:         pick('modelBeChaseSeconds'),
      modelMomentumStallSeconds:   pick('modelMomentumStallSeconds'),
