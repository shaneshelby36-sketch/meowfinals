...
const MODEL_SETUPS = [
  ...
  },
  {
    ...
    shadowEnabled: true,
    label: 'BTC + SOL only',
    why: 'BTC + SOL, same Core settings (conf 55, stall 4s, stagnation 60s, TP +11¢). Tighter crypto pair without ETH.',
  ...
  {
    id: 'majors',
    label: 'Majors (BTC + SOL + ETH)',
    why: 'More opportunities if Core feels too quiet. Three proven coins, conf 62, 2 slots.',
    autoTradeSymbols: 'BTC,SOL,ETH',
  ...
  },
  {
    ...
    why: 'Conf 55 — closest to the ~55% WR tape. 3 slots, slightly easier live favor. Compare remaining cash vs Core.',
    autoTradeSymbols: 'BTC,SOL,ETH',
    modelMinConfidence: 55,
    modelEntryLiveLeanMarginPct: 3,
  ...
  },
  {
    ...
    why: 'Core coins/conf, but slower scratches. Tests if holding −2–4¢ dips beats cutting them early.',
    autoTradeSymbols: 'BTC,SOL',
    modelMinConfidence: 55,
    modelEntryLiveLeanMarginPct: 3,
    modelBankGreenCents: 7,
...
const MODEL_PROB_DRIFT_PTS_DEFAULT = 35;
...
module.exports = {
  ...
  modelCommodityRideToSettle,
  modelCommodityMinEntryCents,
